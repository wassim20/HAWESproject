...
public class Reclamation1 {
    ...
    public Reclamation1(int id_rec,String reclamation, int traite, Date dateAjoutrec, Date dateTraitrec, int id_hbg, int idUser) {
        this.id_rec = id_rec;
        this.id_hbg = id_hbg;
        this.idUser = idUser;
    ...
    public String toString() {
        //return "Reclamation{" + " description=" + desc_rec + ", traitée=" + traite + ", Date Ajout=" + dateAjoutrec + ", Date traitement =" + dateTraitrec + '}';
                return "Reclamation : " + "  desc_rec=" + desc_rec + ", \ntraitement Status =" + traite + ", \ndate d'ajouter=" + dateAjoutrec + ", \ndate de Traitement=" + dateTraitrec +"\n \n \n" ;
...
*/
    ...
    public String Showall() {
        return "Reclamation{" + ", desc_rec=" + desc_rec + ", traite=" + traite + " \n, dateAjoutrec=" + dateAjoutrec + "      , dateTraitrec=" + dateTraitrec + '}';
    }
}
