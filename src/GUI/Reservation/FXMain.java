...
public class FXMain extends Application {
    ...
    public static void showAlertWithHeaderText(Object o, String s, String op) {
        ...
        if(s.length()==0){
            ...
            }else if ( o.getClass() == p.getClass() ){
                if (op.equals("+")){
                    alert.setHeaderText("Paiement Ajoutée avec succés:");
                }
                if (op.equals("-")){
                    alert.setHeaderText("Paiment Supprimé avec succés:");
                }
                if (op.equals("*")){
                    alert.setHeaderText("Paiement Modifié avec succés:");
                }
            }
        }else{
